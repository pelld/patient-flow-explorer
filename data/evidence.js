/* ========================================================================== 
   ...
   --------------------------------------------------------------------------
   Every modelled relationship points to one or more records here. Evidence,
   local estimates and assumptions remain separate so the tool can show where
...
/* ========================================================================== 
   ...
   --------------------------------------------------------------------------
   These values only demonstrate how the tool works. They are not local or
